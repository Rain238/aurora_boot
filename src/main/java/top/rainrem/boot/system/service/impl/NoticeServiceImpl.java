...
import top.rainrem.boot.system.converter.NoticeConverter;
import top.rainrem.boot.system.enums.NoticePublishStatusEnum;
import top.rainrem.boot.system.enums.NoticeTargetEnum;
import top.rainrem.boot.system.mapper.NoticeMapper;
import top.rainrem.boot.system.model.bo.NoticeBO;
import top.rainrem.boot.system.model.dto.NoticeDTO;
...
import top.rainrem.boot.system.service.UserOnlineService;
...
public class NoticeServiceImpl extends ServiceImpl<NoticeMapper, Notice> implements NoticeService {
    ...
    /**
     * 注入 Spring WebSocket 消息模板，用于服务端主动向订阅了特定地址的客户端推送消息
     */
    ...
    public IPage<NoticePageVO> getNoticePage(NoticePageQuery queryParams) {
        Page<NoticeBO> noticePage = this.baseMapper.getNoticePage(new Page<>(queryParams.getPageNum(), queryParams.getPageSize()), queryParams);
    ...
    public boolean revokeNotice(Long id) {
        ...
        if (revokeResult) {
            ...
            userNoticeService.remove(new LambdaQueryWrapper<UserNotice>().eq(UserNotice::getNoticeId, id));
        }
        return revokeResult;
    }
    ...
    public IPage<UserNoticePageVO> getMyNoticePage(NoticePageQuery queryParams) {
        ...
        return userNoticeService.getMyNoticePage(new Page<>(queryParams.getPageNum(), queryParams.getPageSize()), queryParams);
    }
